/* Filename: list.cpp
   ...
   Modified:  March 14, 2014 to use new inside a try...catch when allocating memory.

   Modified:  Jan 2, 2018 to use the modern version of dynamic memory allocation with
              new inside of a try...catch.
